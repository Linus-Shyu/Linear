    ...
    while True:
        ...
        if(command == 'code'):
            ...
            try:
                ...
                os.system('code ' "/Users/" + user + "/Desktop/" + File)
            except:
        ...
        if(command != 'home' and command != 'contest' and command != 'rank' and command != 'userdata' and command != 'play' and command != 'task' and command != 'submit' and command != 'stand' and command != 'code' and command != 'clear' and command != 'time' and command != 'about' and command != '' and command.strip() != ''):
